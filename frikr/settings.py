...
# Read from the environment; the fallback is an insecure placeholder for local
...
# Defaults to True to preserve the local dev experience; set DJANGO_DEBUG=False
# (and DJANGO_ALLOWED_HOSTS) in production.
