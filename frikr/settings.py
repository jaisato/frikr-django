...
# Read from the environment in production; falls back to the historical
# development value so local dev keeps working out of the box.
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    '_*)@a(&k7thzg4aekyet8cewfjmx$z5vz$fnc&z!q)u+l-ptn7'
)
